...
ssd1306test: ${OBJDIR}/fsgpio.o ${OBJDIR}/spi.o ${OBJDIR}/ssd1306.o ${OBJDIR}/ssd1306test.o
	${CC} ${CFLAGS} ${OBJDIR}/fsgpio.o ${OBJDIR}/spi.o ${OBJDIR}/ssd1306.o ${OBJDIR}/ssd1306test.o -o ${BINDIR}/ssd1306test
